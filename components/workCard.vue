<template>
    <div class="w-full">
        <NuxtLink :to="$props.url" target="_blank" rel="noreferrer noopener"
            ...
            <NuxtImg class="object-contain w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
                :src="$props.thumbnail ?? generatePlaceholder($props.name)" placeholder sizes="384px md:192px" />
