<template>
  <div class="grid gap-16 sm:grid-cols-2 lg:grid-cols-5 justify-items-center">
    <WorkCard v-for="work in filteredWorkList" :key="work.name" :name="work.name" :description="work.description"
      :job="work.job" :startDate="work.startDate" :endDate="work.endDate" :thumbnail="work.thumbnail" :url="work.url" />
  </div>
</template>
...
const workList: Work[] = [
  {
    ...
    thumbnail:
      "https://tr.rbxcdn.com/8d60fc74f8ee02643ac4945e9911212a/150/150/Image/Png",
  ...
  },
  {
    ...
    description:
      "Create your own cult, as a lamb. Roguelike + Resources Managment (Non Roblox)",
  ...
  },
  {
    ...
    thumbnail:
      "https://tr.rbxcdn.com/9a781970ccc4693cc5ae840286fe592d/150/150/Image/Png",
    url: "https://www.roblox.com/games/6675127933",
  },
  {
    name: "Edward the Man-Eating Train",
    description:
      "A game where you have to survive a train killing you. (Roblox)",
    job: "Moderator",
    startDate: new Date(2022, 12),
    thumbnail:
      "https://tr.rbxcdn.com/d8cfc19d65bc40ae0afe122a1135064b/150/150/Image/Png",
  ...
  },
  {
    ...
    thumbnail: "/thumbnail/unhappy_raccoon.jpg",
    url: "https://discord.gg/fNZ8CHVJvy",
  },
  {
    ...
    thumbnail:
      "https://tr.rbxcdn.com/fbe3b3d0205ec6a2773c4ed6a8364614/150/150/Image/Png",
    url: "https://www.roblox.com/games/7131355525",
    isTransfur: true,
  },
  {
    name: "RESURGENCED",
    ...
    thumbnail:
      "https://tr.rbxcdn.com/da0303f714c4028c55bec4bd018a9dab/150/150/Image/Png",
    url: "https://www.roblox.com/games/6306910204",
    isTransfur: true,
  },
  {
    name: "Altered",
  ...
  {
    name: "RESURGENCED Roleplay",
    description: "TODO (Roblox)",
    job: "Scripter",
    startDate: new Date(2021, 6),
    endDate: new Date(2021, 12),
    thumbnail:
      "https://tr.rbxcdn.com/09dae6655385c9c21fdf72803362c364/150/150/Image/Png",
    url: "https://www.roblox.com/games/6464459617",
    isTransfur: true,
  },
  {
    name: "Kaiju Paradise",
    ...
    endDate: new Date(2021, 9),
    thumbnail:
      "https://tr.rbxcdn.com/2c03aff9e324472dd094e688e1a82f31/150/150/Image/Png",
    url: "https://www.roblox.com/games/6456351776",
    isTransfur: true,
  },
  {
    name: "Lyricity",
    description:
      "Discord server for a composer called 'LyricWulf' (Non Roblox)",
    job: "Moderator",
...
const filteredWorkList = workList
  .filter((work) => !work.isTransfur || (showTransfurWork && work.isTransfur))
  .sort(
